      ...
      <div className="ml-6 flex w-16 flex-col items-center space-y-10 py-6">
        <div className="flex items-center justify-center rounded-md p-4">
          <a href="#" className="flex items-center">
            <div className="flex md:flex-row items-center flex-shrink-0 mr-6 text-primary sm:flex-col sm:items-center">
              <svg
              ...
              <span className="font-semibold lg:text-xl text-xs tracking-tight">
                Jasper
              </span>
            </div>
          </a>
